...
<img src="/assets/img/devink.png" alt="DevInk" width="100"/>

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue.svg)](https://python.org)
[![Vue 3.x](https://img.shields.io/badge/Vue-3.x-green.svg)](https://vuejs.org)
[![FastAPI latest](https://img.shields.io/badge/FastAPI-latest-teal.svg)](https://fastapi.tiangolo.com)
[![AI DashScope](https://img.shields.io/badge/AI-DashScope-orange.svg)](#)
[![Built with Vibe Coding](https://img.shields.io/badge/Built%20with-Vibe%20Coding-purple.svg)](#vibe-coding)
...
基于多智能体编排的 AI 博客写作助手。通过协调多个 AI Agent 协作完成博客创作——从标题生成、大纲规划、内容撰写到配图搜索，提供完整的写作工作流，并通过 SSE 实时推送进度。
