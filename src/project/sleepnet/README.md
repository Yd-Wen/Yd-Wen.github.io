...
![SleepNet 管道](/assets/img/sleepnet_pipeline.jpg)

- 架构

![SleepNet 架构](/assets/img/sleepnet_architecture.jpg)

- SleepNet 在 MMActivity 数据集上与 Baseline 的对比

![SleepNet 与 Baseline 对比](/assets/img/sleepnet_comparison_mmac.jpg)
